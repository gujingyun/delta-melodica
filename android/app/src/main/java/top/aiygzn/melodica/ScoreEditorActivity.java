...
public final class ScoreEditorActivity extends Activity {
    ...
    @Override public void onCreate(Bundle saved) {
        ...
        } catch (Exception e) { android.widget.Toast.makeText(this, "曲谱读取失败：" + e.getMessage(), android.widget.Toast.LENGTH_LONG).show(); finish(); return; }
    ...
    private void validate() {
        ...
        } catch (Exception e) { valid = false; parsed = null; preview.clear(); status.setText("请修正：" + e.getMessage()); }
    }
    ...
    private void save() {
        ...
        } catch (Exception e) { status.setText("保存失败，编辑内容仍保留：" + e.getMessage()); }
    }
